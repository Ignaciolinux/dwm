...
static const char *fonts[]          = {"SauceCodePro Nerd Font:size=14:antialias=true:autohint=true",
...
static const char col_01[]			= "#0d0e0f";	/* Color de la barra de estado en reposo*/
static const char col_02[]			= "#0d0e0f";	/* Color del borde de pantalla desenfocada */
static const char col_03[]			= "#ffffff";	/* Color de las letras de la barra de estado */
static const char col_04[]			= "#0d00ff";	/* Color del nombre y etiqueta que está en uso */
static const char col_05[]			= "#ffffff";	/* Color del borde de la ventana enfocada */
static const char col_06[]			= "#0d0e0f";	/* Color barra de estado cuando está en uso */
...
static const Layout layouts[] = {
	...
	{ "ent",      tile },    /* first entry is default */
...
static const char *termcmd[]  = { "st", "-t", "cacharro espartano", NULL };
